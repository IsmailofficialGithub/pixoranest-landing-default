        ...
        <section className="py-24 relative overflow-hidden">
          <div className="max-w-7xl mx-auto px-6">
            <div className="grid md:grid-cols-3 gap-8">
              {features.map((f, i) => (
                <div key={i} className="group relative animate-up">
                  <div className={cn("absolute -inset-1 bg-gradient-to-r opacity-0 group-hover:opacity-100 transition duration-500 blur-xl px-4 py-4 rounded-[32px] -z-10", f.gradient)} />
